...
def build_primer(
    ...
    return (
        ...
        "At session end, use `remember-conversations` only for a durable, novel delta "
        ...
        "consolidate first. Every saved note must be hermetic: expand contextual "
        "shorthand such as 'category 15' or 'scenario 9' with the system or taxonomy "
        "and meaning needed to reuse the note without the originating conversation. "
        "Keep MEMORY.md to at most 20 bullets or 6000 characters "
        "with summaries under 30 words, and per-fact notes under 200 words. At the "
        "cap, merge or replace stale entries instead of appending. Do not create a "
