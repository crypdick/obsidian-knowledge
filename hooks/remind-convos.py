...
REASON = (
    ...
    "happened. (2) Diary note — if you worked through a process, incident, or "
    "debugging session worth narrating. (3) Convo note — if you produced "
    "analysis, comparisons, or decision rationales. (4) Guide — if you "
    "discovered a procedure others would need to repeat. Think especially "
    ...
    "vault's wiki/ tree (wiki/systems/..., wiki/life/..., etc.) — NOT in "
    "~/.claude/projects/.../memory/. The auto-memory directory is deprecated "
    "for this vault; knowledge belongs in wiki/, behavior rules belong in "
    "CLAUDE.md. Use the remember-conversations skill to file. If nothing worth "
    "preserving or you already filed, carry on."
)
